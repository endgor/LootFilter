...
LootFilter.Locale = {
	...
	LocText = {
		...
		["LToolTip5"] = "Los objetos que coinciden con esta lista se MANTIENEN.\n\nUn nombre por l\195\173nea. No distingue may\195\186sculas/min\195\186sculas.\n\nExacto:              Piedra de hogar\nComod\195\173n (*):      *Poci\195\179n*  (contiene 'Poci\195\179n')\n                            Poci\195\179n*    (empieza con 'Poci\195\179n')\n                            *Poci\195\179n    (termina con 'Poci\195\179n')\nParcial (#):         #Poci\195\179n   (contiene 'Poci\195\179n')\nTooltip (##):       ##Ligado al alma\nComentario:         *Poci\195\179n* ; mi comentario\n\nEl prefijo '#' soporta patrones Lua para b\195\186squeda avanzada.",
