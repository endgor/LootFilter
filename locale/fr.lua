...
LootFilter.Locale = {
		...
		radioButtonsText= {
			...
			-- Glyph
			["TYGlyphMajor Glyph"]= "Glyphe majeure",
			["TYGlyphMinor Glyph"]= "Glyphe mineure",
			...
			["TYWeaponTwoHandedAxes"]= "Haches � deux mains",
			["TYWeaponTwoHandedMaces"]= "Masses � deux mains",
			["TYWeaponTwoHandedSwords"]= "Epees � deux mains",
		...
		LocTooltip = {
			...
			["LToolTip5"] = "Les objets qui correspondent a cette liste sont GARDES.\n\nUn nom par ligne. La casse est ignoree.\n\nExact:                  Pierre de foyer\nJoker (*):              *Potion*  (contient 'Potion')\n                               Potion*    (commence par 'Potion')\n                               *Potion    (finit par 'Potion')\nPartiel (#):            #Potion   (contient 'Potion')\nInfo-bulle (##):    ##Lie\nCommentaire:        *Potion* ; mon commentaire\n\nLe prefixe '#' supporte les modeles Lua pour la recherche avancee.",
			["LToolTip6"] = "Les objets qui correspondent a cette liste sont SUPPRIMES.\n\nUn nom par ligne. La casse est ignoree.\n\nExact:                  Pierre de foyer\nJoker (*):              *Potion*  (contient 'Potion')\n                               Potion*    (commence par 'Potion')\n                               *Potion    (finit par 'Potion')\nPartiel (#):            #Potion   (contient 'Potion')\nInfo-bulle (##):    ##Lie\nCommentaire:        *Potion* ; mon commentaire\n\nLe prefixe '#' supporte les modeles Lua pour la recherche avancee.",
