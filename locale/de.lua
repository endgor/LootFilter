...
if ( GetLocale() == "deDE" ) then
	LootFilter.Locale = {
		...
		LocTooltip = {
			...
			["LToolTip5"] = "Gegenst\195\164nde die hier aufgef\195\188hrten sind, werden BEHALTEN.\n\nEin Name pro Zeile. Gross-/Kleinschreibung wird ignoriert.\n\nExakt:              Ruhestein\nPlatzhalter (*):  *Trank*  (enth\195\164lt 'Trank')\n                          Trank*    (beginnt mit 'Trank')\n                          *Trank    (endet mit 'Trank')\nTeilsuche (#):   #Trank   (enth\195\164lt 'Trank')\nTooltip (##):     ##Seelengebunden\nKommentar:       *Trank* ; mein Kommentar\n\nDas '#' Pr\195\164fix unterst\195\188tzt Lua-Muster f\195\188r erweiterte Suche.",
